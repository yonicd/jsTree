...
![downloads](http://cranlogs.r-pkg.org/badges/jsTree)[![Travis-CI Build Status](https://travis-ci.org/yonicd/jsTree.svg?branch=master)](https://travis-ci.org/yonicd/jsTree)[![Coverage Status](https://img.shields.io/codecov/c/github/yonicd/jsTree/master.svg)](https://codecov.io/github/yonicd/jsTree?branch=master)
