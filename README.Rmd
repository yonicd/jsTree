...
Data can be a data.frame or a string that is collapse columns to text (with seperator). When the data
is a data.frame the seperator is controlled by `x$sep`.
